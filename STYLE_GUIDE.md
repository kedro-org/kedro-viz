...
Before requesting a review on a PR, be sure to first fully self-review [by comparing changes](https://docs.github.com/en/github/collaborating-with-issues-and-pull-requests/about-comparing-branches-in-pull-requests) line by line and make any amends with this style guide in mind.

Manually [cross browser](#browser-and-device-support) and [regression test](https://en.wikipedia.org/wiki/Regression_testing) the PR branch against the behaviour of the [previous release](https://quantumblacklabs.github.io/kedro-viz/). Resolve problems where practical or otherwise make note of them in the PR text before requesting a review.
