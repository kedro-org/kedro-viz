export const updateContent = {
  ...
  features: [
    ...
    {
      title: 'Brand new documentation using MKdocs',
      image: '',
      copy: 'We’ve revamped our documentation with MkDocs. Enjoy a cleaner, and more intuitive experience with improved structure, better navigation, and easier access to the information you need.',
