export const statusMockData = {
    "nodes": {
        ...
        "7932e672": {
            ...
            "type": "task",
            "status": "success",
            "duration": 0.0043736661318689585,
            "error": null
        },
        "e50f81b8": {
    ...
    "datasets": {
       ...
       "pipeline": {
        ...
        "start_time": null,
        "end_time": null,
        "duration": 1.410506376530975,
        "status": "failed",
        "error": "Failed while loading data from dataset CSVDataset(filepath=/Users/Jitendra_Gundaniya/QB/kedro-viz-run-ws/kedro-viz/demo-project/data/01_raw/companies.csv, load_args={}, protocol=file, save_args={'index': False}).\n[Errno 2] No such file or directory: '/Users/Jitendra_Gundaniya/QB/kedro-viz-run-ws/kedro-viz/demo-project/data/01_raw/companies.csv'",
    } 
}