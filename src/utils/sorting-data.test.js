...
describe('sorting data', () => {
  describe('return expected metrics which should not have the first 3 metrics keys "Dataset1.Metrics1", "Dataset1.Metrics2", and "Dataset1.Metrics3"', () => {
    const expected = {
  ...
  describe('return expected runs which should not have the first 3 values', () => {
    const expected = {
