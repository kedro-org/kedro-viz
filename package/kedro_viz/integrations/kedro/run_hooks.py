...
class PipelineRunHooks:
    ...
    @hook_impl
    def after_dataset_loaded(self, dataset_name: str, data: Any, node: KedroNode) -> None:  # ruff: noqa: ARG002
        self._add_event(
            create_dataset_event(
    ...
    @hook_impl
    def after_dataset_saved(self, dataset_name: str, data: Any, node: KedroNode) -> None:  # ruff: noqa: ARG002
        self._add_event(
            create_dataset_event(
