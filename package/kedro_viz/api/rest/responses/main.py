"""`kedro_viz.api.rest.responses.main` contains response classes 
and utility functions for the `/main` REST endpoint"""
...
def get_pipeline_response(pipeline_id: str = None) -> GraphAPIResponse:
