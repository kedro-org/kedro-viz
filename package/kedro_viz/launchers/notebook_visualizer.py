...
class NotebookVisualizer:
    def show(self, pipeline: Union[Pipeline, Dict[str, Pipeline]], catalog: DataCatalog = None, options: Dict[str, Any] = None):
        """
        ...
        """
        notebook_user = NotebookUser(pipeline=pipeline, catalog=catalog, options=options)
