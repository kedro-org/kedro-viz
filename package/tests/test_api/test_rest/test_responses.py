...
from kedro_viz.models.flowchart.flowchart import TaskNode
...
class TestAppMetadata:
    def test_get_metadata_response(self, mocker):
        mock_get_compat = mocker.patch(
            "kedro_viz.api.rest.responses.get_package_compatibilities",
            return_value="mocked_compatibilities",
        )
        mock_set_compat = mocker.patch(
            "kedro_viz.api.rest.responses.Metadata.set_package_compatibilities"
        )
