...
| `testData` | `/src/utils/data/test-data.json` |
...
Alternatively, you can synchronously load one of the mock datasets in `/src/utils/data`. The 'testData' dataset is mainly used as mock data for unit testing, while the 'demo' dataset is used on the [public demo](https://quantumblacklabs.github.io/kedro-viz/).
