...
and our __layer constraint__ by adding intermediate layer nodes ([code](https://github.com/quantumblacklabs/kedro-viz/blob/210974eb743a8116d6656ce41abe5ecee770dbcd/src/utils/graph/layout.js#L106-L136))
...
This results in a relatively short path for each edge, where most path segments tend to be vertical, with its processing completed quickly in practice ([code](https://github.com/quantumblacklabs/kedro-viz/blob/main/src/utils/graph/routing.js)).
...
Finally, we render the finished routes to the user as smooth bezier curves ([code](https://github.com/quantumblacklabs/kedro-viz/blob/210974eb743a8116d6656ce41abe5ecee770dbcd/src/components/flowchart/draw.js#L243-L311)), as we find we can read them easier than straight lines.
