...
- `newparams` - From release v3.12.0. Enables new behaviour of parameter nodes, which includes disabling parameter nodes by default, and will be highlighted on toggling their visibility. (default false)
